...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-02-2022 a las 15:17:20
...
CREATE TABLE `proveedor` (
  ...
  `tipotrans` varchar(15) DEFAULT NULL,
...
INSERT INTO `proveedor` (`idSupplier`, `nombreFiscal`, `nombreComercial`, `negocio`, `numeroCliente`, `rfc`, `correo`, `direccion`, `ciudad`, `estado`, `codigoPostal`, `numeroTel`, `tipoCompañia`, `terminoPago`, `tipotrans`, `provfijo`, `archivos`) VALUES
(1, 'alfa', 'alfa', '23', '23', 'PAM130308SJ0', 'jsventura997@gmail.c', '1231231', 'ciudad', 'estado', '12345', '8912233', 'otro', 1, 'Nacional', 'SI', 'RAHF740523647CCOT0000000226 (3).pdf;message.txt;0200466014-FACT-B1-188054420P1-3.pdf;0200466014-FACT-B1-188054420P1-3.xml');
