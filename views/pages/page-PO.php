                ...
                <div class="tile-body">
                    <form class="form-horizontal" enctype="multipart/form-data" method="POST">
                        <div class="row">
                                        ...
                                        <select class="form-control" style="height: 35px;" name="proveedor" id="proveedor">
                                            ...
                                            <?php foreach ($inst->obtnProveedores() as $key => $value) : ?>
                                                <option value="<?php echo $value["idSupplier"] ?>">
                                                    ...
                                                    echo $value["provfijo"] == "SI" ? " *PROVEEDOR FIJO*" : ""; ?>
                                                </option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                            ...
                            <div class="col-auto">
                                <div class="form-group row" style="align-items: center;">
                                    <label class="control-label col-auto" for="divisa">Divisa</label>
                                    <div class="col">
                                ...
                                <div class="form-group row" style="align-items: center;">
                                    ...
                                    <div class="toggle-flip col ml-3 mt-2">
                                        <label>
                        ...
                        <table class="table" id="tabla">
                            ...
                            <tr class="fila-fija">
                                ...
                                <td>
                                <input list="UOM" type="text" class="form-control" name="UOM[]" id="UOM">
                                </td>
...
if (!empty($_POST)) {
    foreach ($inst->obtnProveedores() as $key => $value) {
        if ($_POST["proveedor"] == $value["idSupplier"])
            break;
    }
    $registro =  new controladorFormularios;
    $registro->ctrRegistroPO($value["provfijo"]);
}
