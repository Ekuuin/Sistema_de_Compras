...
class ControladorFormularios
{
	...
	static public function ctrRegistroProveedor($files)
	{
		$respuesta = ModeloFormularios::mdlRegistroProveedor($files);
		return $respuesta;
	}

	static public function ctrUpdateProveedor($id)
	{
		if (isset($_POST)) {
			$data = $_POST;
			$respuesta = ModeloFormularios::mdlUpdateProveedor($data, $id);
			if ($respuesta)
        ...
        window.location = "index.php?pagina=page-proveedor";
        </script>';
		}
	}
	...
	public function ctrRegistroPO($provfijo)
	{
		if (isset($_POST["proveedor"])) {
			$data = $_POST;
			$id = ModeloFormularios::mdlRegistrarPO($data, $_SESSION['usuario'], $provfijo);
